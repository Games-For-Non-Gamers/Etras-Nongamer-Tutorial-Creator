        ...
        public override void OnGUI(Rect pos, SerializedProperty prop, GUIContent label)
        {
            ...
            switch (state)
            {
                ...
                case EtraAnimationEvent.AnimationEvents.BasicUiGrowAndToStartWithNoUnlock:
                    ...
                    EditorGUI.PropertyField(new Rect(pos.x, pos.y + 70, pos.width, 20), basicGrowScale);
                    SerializedProperty basicGrowWait = prop.FindPropertyRelative("basicGrowWait");
                    EditorGUI.PropertyField(new Rect(pos.x, pos.y + 90, pos.width, 20), basicGrowWait);
                    break;
