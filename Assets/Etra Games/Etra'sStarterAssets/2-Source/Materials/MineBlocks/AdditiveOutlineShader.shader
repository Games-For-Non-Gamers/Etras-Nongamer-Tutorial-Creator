// Original shader isCrest Ocean System Shader "Crest/Inputs/Foam/Add From Texture"
// This file is subject to the MIT License as seen in the third part notices document

Shader "Custom/AdditiveOutlineShader"
{
	Properties
	{
